namespace GHI.PythonSharp.Compiler
{
    ...
    public class Lexer : IDisposable
    {
        ...
        private Stack lastChars = new Stack();
        ...
        public Token NextToken()
        {
            ...
            {
                return this.tokenStack.Pop() as Token;
            }
            ...
            if (CharExtensions.IsDigit(ch))
                return this.NextInteger(ch);

            if (CharExtensions.IsLetter(ch) || ch == '_')
            ...
            if (Operators.IndexOf(ch)>-1 || OperatorStarts.IndexOf(ch)>-1)
        ...
        {
            return CharExtensions.IsWhiteSpace(ch) && ch != '\r' && ch != '\n';
        }
        ...
        private Token NextOperator(char ch)
        {
            ...
            if (ich2 >= 0)
            {
                ...
                if (Strings.Contains( otherOperators,op))
                {
                    return new Token()
                    {
        ...
        private Token NextInteger(char ch)
        {
            ...
            while (ich >= 0 && CharExtensions.IsDigit((char)ich))
            {
                integer += (char)ich;
                ich = this.NextChar();
            }
        ...
        private Token NextName(char ch)
        {
            ...
            while (ich >= 0 && (CharExtensions.IsLetterOrDigit((char)ich) || (char)ich == '_'))
            {
                name += (char)ich;
                ich = this.NextChar();
            }
        ...
        private int NextCharSkipBlanks()
        {
            ...
            while (ich >= 0)
            {
                ...
                if (!CharExtensions.IsWhiteSpace(ch) || ch == '\n' || ch == '\r')
                    break;
